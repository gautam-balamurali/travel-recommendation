...
const COUNTRY_DICTIONARY = {
  India: [
    ...
    },
    {
      ...
      rating: "9.5/10",
      description:
        "Lucknow, is the capital of the state of Uttar Pradesh, a cultural hotspot in northern India for many centuries. Heritage, food, shopping whatever reason you travel for it has them all. Toward its center is Rumi Darwaza, a Mughal gateway. Nearby, the 18th-century Bara Imambara shrine has a huge arched hall. Upstairs, Bhool Bhulaiya is a maze of narrow tunnels with city views from its upper balconies.",
    },
    {
      city_name: "Mumbai",
      rating: "9/10",
    ...
    },
    {
      ...
      rating: "9/10",
      description:
        "Bengaluru (also called Bangalore) is the capital of India's southern Karnataka state. The center of India's high-tech industry, the city is also known for its parks and nightlife. Bengaluru is nicknamed the 'Garden City' for its gardens and parks and was once called a Pensioner's Paradise.",
    },
  ],
  Spain: [
    {
...
export { COUNTRY_DICTIONARY, DEFAULT_COUNTRY };
